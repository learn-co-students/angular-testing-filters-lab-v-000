...
//Write a test to return all the contacts who are female 
//(hint: there are 71 females).

//Write another test to select people from different geographical locations 
//(hint: there are 8 from Manchester).